...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<ul class="treeview-menu">
				<%--<li id="system-setting"><a--%>
						<%--href="../../test/findAll?page=1&size=8"> <i--%>
						<%--class="fa fa-circle-o"></i> 试验计划--%>
				<%--</a></li>--%>
				<%--<li id="system-setting"><a--%>
				<%--href="../../test/findAll"> <i--%>
				<%--class="fa fa-circle-o"></i> 委试预排程--%>
				<%--</a></li>--%>
				<%--<li id="system-setting"><a--%>
						<%--href="../../test/Testcancelled">--%>
					<%--<i class="fa fa-circle-o"></i> 试验取消--%>
				<%--</a></li>--%>
				<%--<li id="system-setting"><a--%>
						<%--href="../../pages/main.jsp">--%>
					<%--<i class="fa fa-circle-o"></i> 试验查询--%>
				<%--</a></li>--%>

				<%--<li id="system-setting"><a--%>
						<%--href="../../test/findAllA?page=1&size=8">--%>
					<%--<i class="fa fa-circle-o"></i> 试验统计--%>
				<%--</a></li>--%>

				<%--<li id="system-setting"><a--%>
						<%--href="../../test/findAllA?page=1&size=8">--%>
					<%--<i class="fa fa-circle-o"></i> RR实验室--%>
				<%--</a></li>--%>
				<li id="system-setting"><a
				...
				<li id="system-setting"><a
						href="../../test/findTestByTestItem?page=1&size=8">
