	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="../user/findAll?page=1&size=10">用户管理</a></li>
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="location.href='../user/findAll?page=1&size=10'">
							...
							<div style="width: 230px;height: 30px;float: right">
								<form action="../user/findByUserUsername" method="post">

									<input style="width: 175px;height: 30px; border-radius:3px" type="text"  name="username"
										   placeholder="请输入用户名查询" value="">
									<button style="width: 55px;height: 30px;float: right;border-radius:3px" type="submit">搜索</button>
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc text-center">用户名</th>
										<th class="sorting_asc sorting_asc_disabled text-center">邮箱</th>
										<th class="sorting_desc sorting_desc_disabled text-center">联系电话</th>
									...
									<c:forEach items="${userList.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="../user/delete?id=${user.id}" class="btn bg-olive btn-xs">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div style="height: 65px" class="box-footer">
						<div style="float: right">
							<ul STYLE="margin:5px" class="pagination">
								<li>
									<a href="../user/findAll?page=1&size=${userList.pageSize}"
									   aria-label="Previous">首页</a>
								</li>
								<li><a href="../user/findAll?page=${userList.pageNum-1}&size=${userList.pageSize}">上一页</a>
								</li>
								<c:forEach begin="1" end="${userList.pages}" var="pppp">
									<li>
										<a href="../user/findAll?page=${pppp}&size=${userList.pageSize}">${pppp}</a>
									</li>
								</c:forEach>
								<li><a href="../user/findAll?page=${userList.pageNum+1}&size=${userList.pageSize}">下一页</a>
								</li>
								<li>
									<a href="../user/findAll?page=${userList.pages}&size=${userList.pageSize}"
