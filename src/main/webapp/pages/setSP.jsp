		...
		<form method="post">
			...
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					<div class="panel-heading">SP实验室工时设定</div>
						...
						<tr>
							...
							<div>
								<button style="float: left" type="button" class="btn btn-default" title="刷新"
										onclick="location.href='../workTimeSp/findWorkTimeSPShuaXin'" id="SPB">
									<i class="fa fa-cube"></i> 刷新
								</button>
								<button style="float: left" type="button" class="btn bg-default"
										onclick="location.href='../test/findTestByTestItemSP'">返回
								</button>
								...
								<div style="width: 230px;height: 30px;float: right">
									<form action="../workTimeSp/findWorkTimeSPSouSuo" method="post">
					...
					<tr>
						...
						<td id="qqq" class="text-center">
							<button type="button" class="btn bg-olive btn-xs"
									onclick="location.href='../workTimeSp/deleteWorkTimeIdSP?id=${Work.id}'">删除</button>
						</td>
							...
							<%--<div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog" aria-labelledby="myModalLabelB" aria-hidden="true">--%>
								<%--<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;" >--%>
									<%--<div class="modal-content" >--%>
										...
										<%--</div>--%>
										<%--<form id="formB" action="../workTimeSp/UpdateWorkTimeSP" method="post">--%>
											<%--<div class="row data-type">--%>
		...
		<script>
            ...
            function baocun(){
                ...
                if(flag==false){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath }/workTimeSp/setSP",
                        type:"POST",
                        async:false,
                        traditional:true,
                        data:{
                        ...
                        success:function(data){
                            alert(data);
                            window.location.href='../workTimeSp/findWorkTimeSPShuaXin'
