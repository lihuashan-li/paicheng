		...
		<form method="post">
			...
			<section class="content">
				...
				<div class="panel panel-default">
					<div class="panel-heading">HSU实验室工时设定</div>
						...
						<tr>
							...
							<div>
								<button style="float: left" type="button" class="btn btn-default" title="刷新"
										onclick="location.href='../workTimeHSU/findWorkTimeHSUShuaXinHSU'" id="HSUB">
									<i class="fa fa-cube"></i> 刷新
								</button>
								<button style="float: left" type="button" class="btn bg-default"
										onclick="location.href='../test/findTestByTestItemHSU'">返回
								</button>
								<a>今天向前2天的时间已经隐藏，如需查看，请搜索</a>
								<div style="width: 230px;height: 30px;float: right">
									<form action="../workTimeHSU/findWorkTimeSouSuoHSU" method="post">
					...
					<tr>
						...
						<td id="qqq" class="text-center">
							<button type="button" class="btn bg-olive btn-xs"
									onclick="location.href='../workTimeHSU/deleteWorkTimeIdHSU?id=${Work.id}'">删除</button>
						</td>
							...
							<%--<div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog" aria-labelledby="myModalLabelB" aria-hidden="true">--%>
								<%--<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;" >--%>
									<%--<div class="modal-content" >--%>
										...
										<%--</div>--%>
										<%--<form id="formB" action="../workTimeHSU/UpdateWorkTimeHSU" method="post">--%>
											<%--<div class="row data-type">--%>
		...
		<script>
            ...
            function baocun(){
                    ...
                    if(flag==false){
                        ...
                        $.ajax({
                            url:"${pageContext.request.contextPath }/workTimeHSU/setHSU",
                            type:"POST",
                            async:false,
                            traditional:true,
                            data:{
                            ...
                            success:function(data){
                                alert(data);
                                window.location.href='../workTimeHSU/findWorkTimeHSUShuaXinHSU';
