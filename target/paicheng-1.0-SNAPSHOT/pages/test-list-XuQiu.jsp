						...
						<div class="table-box">
							...
							<%--<div class="pull-left">--%>
								<%--<div class="form-group form-inline">--%>
									<%--<div class="btn-group">--%>
										<%--&lt;%&ndash;<button type="button" class="btn btn-default" title="新建"&ndash;%&gt;--%>
											<%--&lt;%&ndash;onclick="location.href='../pages/product-add.jsp'">&ndash;%&gt;--%>
											<%--&lt;%&ndash;<i class="fa fa-file-o"></i> 新建&ndash;%&gt;--%>
										<%--&lt;%&ndash;</button>&ndash;%&gt;--%>
										<%--&lt;%&ndash;<button type="button" class="btn btn-default" title="删除">&ndash;%&gt;--%>
											<%--&lt;%&ndash;<i class="fa fa-trash-o"></i> 删除&ndash;%&gt;--%>
										<%--&lt;%&ndash;</button>&ndash;%&gt;--%>
										...
										<%--&lt;%&ndash;</button>&ndash;%&gt;--%>
										<%--&lt;%&ndash;<button type="button" class="btn btn-default" title="筛选">&ndash;%&gt;--%>
											<%--&lt;%&ndash;<i class="fa fa-refresh"></i> 筛选&ndash;%&gt;--%>
										<%--&lt;%&ndash;</button>&ndash;%&gt;--%>
											...
											<%--<button type="button" class="btn btn-default" title="BC"--%>
											 <%--onclick="location.href='../test/findTestByTestItem'">--%>
