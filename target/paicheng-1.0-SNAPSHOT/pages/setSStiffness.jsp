...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<form method="post">
			...
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					<div class="panel-heading">Static Stiffness实验室工时设定</div>
				...
				<div class="box-tools text-center">
					<button  class="btn bg-maroon" onclick="baocun()">保存</button>
				</div>
			</section>
		</form>
						...
						<tr>
							...
							<div>
								<button style="float: left" type="button" class="btn btn-default" title="刷新"
										onclick="location.href='../workTimeSStiffness/findWorkTimeSStiffnessShuaXin'">
									<i class="fa fa-cube"></i> 刷新
								</button>
								<button style="float: left" type="button" class="btn bg-default"
										onclick="location.href='../test/findTestByTestItemSStiffness'">返回
								</button>
								...
								<div style="width: 230px;height: 30px;float: right">
									<form action="../workTimeSStiffness/findWorkTimeSStiffnessSouSuo" method="post">

										<input style="width: 175px;height: 30px; border-radius:3px" type="text" id="gotoworkCe"
											   name="gotowork"
					...
					<tr>
						...
						<td id="qqq" class="text-center">
							<button type="button" class="btn bg-olive btn-xs"
									onclick="location.href='../workTimeSStiffness/deleteWorkTimeIdSStiffness?id=${Work.id}'">删除</button>
						</td>
							...
							<%--<div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog" aria-labelledby="myModalLabelB" aria-hidden="true">--%>
								<%--<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;" >--%>
									<%--<div class="modal-content" >--%>
										...
										<%--</div>--%>
										<%--<form id="formB" action="../workTimeSStiffness/UpdateWorkTimeSStiffness" method="post">--%>
											<%--<div class="row data-type">--%>
		...
		<script>
			...
			function baocun(){
                action="../workTimeSStiffness/setSStiffness"
                //  获取到用户输入信
                ...
                if(flag==false){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath }/workTimeSStiffness/setSStiffness",
                        type:"POST",
                        async:false,
                        traditional:true,
                        data:{
                        ...
                        success:function(data){
                            alert(data);
                            window.location.href='../workTimeSStiffness/findWorkTimeSStiffnessShuaXin'
