            ...
            <div class="box box-primary">
                ...
                <%--<shiro:hasPermission name="SP已排批量操作">--%>
                    <button type="submit" id="submit" class="btn btn-default" title="批量操作" class="btn bg-olive btn-xs"
                            data-toggle="modal" data-target="#myModalHSUPiLiang" onclick="pilianganniu()">
                        <i class="fa fa-cube"></i> 批量操作
                    </button>
                <%--</shiro:hasPermission>--%>

                <button type="button" class="btn btn-default" title="数据导出"
                        onclick="location.href='../test/ShuJuDaoChuHSU'">
                    ...
                    <div class="table-box">
                        ...
                        <div class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                ...
                                <tbody>
                                <%--<from  >--%>
                                <c:forEach items="${testListHSU.list}" var="test" varStatus="cou">
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP操作">--%>
                                                <button type="submit" class="btn bg-olive btn-xs" data-toggle="modal"
                                                        data-target="#myModalHSU"
                                                        onclick="ValuesHSU(${test.number},'${test.id}',${test.spbh},${test.red},${test.caozuo})">操作
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP取消">--%>
                                                <button id="buttonA" type="button" class="btn bg-olive btn-xs"
                                                    <%--onclick="location.href='../test/updateCancelSStiffness?id=${test.id}&number=${test.number}'">--%>
                                                        onclick="ValuesQuXiaoHSU('${test.id}',${test.number})">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <div class="text-center">
                                    <div class="modal fadeA" id="myModalHSU" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelHSU" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                ...
                                                <form id="form" action="../test/TestNumberHSU" method="post">
                                                ...
                                                <form id="formAAA" action="../abnormal/saveAbnormalHSU" method="post">
                                                    <h4>请输入试验暂停原因：</h4>
                                    ...
                                    <%--批量操作模态框--%>
                                    <div class="modal fadeA" id="myModalHSUPiLiang" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelHSUPiLiang" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"
                                                ...
                                                <form id="formPiLiang" action="../test/PiLiangTestNumberHSU"
                                                      method="post">
                                                ...
                                                <form action="../test/JinRuDaiPaiHSU" method="post">
                                                ...
                                                <form action="../test/PiLiangQuXiaoYiPaiHSU" method="post">
            ...
            <div style="height: 65px" class="box-footer">
                <div style="float: right">
                    <ul STYLE="margin:5px" class="pagination">
                        ...
                        <li>
                            <a href="../test/findTestByTestItemHSU?page=1&size=${testListHSU.pageSize}"
                               aria-label="Previous">首页</a>
                        </li>
                        <li><a href="../test/findTestByTestItemHSU?page=${testListHSU.pageNum-1}&size=${testListHSU.pageSize}">上一页</a>
                        </li>
                        <c:forEach begin="1" end="${testListHSU.pages}" var="pppp">
                            <li>
                                <a href="../test/findTestByTestItemHSU?page=${pppp}&size=${testListHSU.pageSize}">${pppp}</a>
                            </li>
                        </c:forEach>
                        <li><a href="../test/findTestByTestItemHSU?page=${testListHSU.pageNum+1}&size=${testListHSU.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="../test/findTestByTestItemHSU?page=${testListHSU.pages}&size=${testListHSU.pageSize}"
                    ...
                    <div class="table-box">
                                ...
                                <div>
                                    ...
                                    <%--<shiro:hasPermission name="SP待排批量操作">--%>
                                        <button type="submit" id="Dsubmit" class="btn btn-default" title="批量操作"
                                                ...
                                                data-target="#myModalHSUPiLiangDaiPai" onclick="pilianganniuDaiPai()">
                                            <i class="fa fa-cube"></i>批量操作
                                        </button>
                                    <%--</shiro:hasPermission>--%>
                                    <button type="button" class="btn btn-default" title="待排数据导出"
                                            onclick="location.href='../test/ShuJuDaoChuDaiPaiHSU'">
                                    ...
                                    <div style="width: 230px;height: 30px;float: right">
                                        <form action="../test/findByTestRequestIdDaiPaiHSU" method="post">
                        ...
                        <div id="daipai" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataListAAAA"
                                ...
                                <c:forEach items="${HSU}" var="test" varStatus="cou">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP顺位排程">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/updateStateHSU?id=${test.idRctest}'">
                                                    顺位排程
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                            ...
                                            <div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="formB" action="../test/TestNumberChaHSU" method="post">
                                                            <h4>请输入需要把该数据调整到第几位：</h4>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP待排取消">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/TestCancelHSU?id=${test.idRctest}'">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <%--批量操作模态框--%>
                                <div class="modal fadeA" id="myModalHSUPiLiangDaiPai" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabelHSUPiLiangD" aria-hidden="true">
                                    <div style=" width: 350px;height:350px;text-align: center"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="formPiLiangChaWei" action="../test/PiLiangChaWeiHSU" method="post">
                                            ...
                                            <form action="../test/PiLiangShunWeiHSU" method="post">
                                            ...
                                            <form action="../test/PiLiangQuXiaoHSU" method="post">
...
<script>
    ...
    //已排计划单个操作 数据进入到模态框
    $("#myModalHSU").modal("hide");

    function ValuesHSU (ID,id,spbh,red,caozuo) {
        $("#ids").val(ID);
        $("#id").val(id);
        $("#idss").val(ID);
        $("#idID").val(id);
    ...
    function kaishi(_this) {
        ...
        if ($($(_this).parent().parent().children()[1])[0].innerHTML == 1) {
            location.href = '../test/BeginHSU?number=' + number;
        } else {
            if ($($(_this).parent().parent().prev().children()[23])[0].id == "wancheng0") {
                alert("请先开始前一条试验")
            } else {
                location.href = '../test/BeginHSU?number=' + number;
            }
    ...
    function wancheng(id, number) {
        location.href = '../test/updateCompleteHSU?id=' + id + '&number=' + number;
    }



    function ValuesQuXiaoHSU (id,number) {
        if (confirm("操作确认!")){
            location.href='../test/ValuesQuXiaoHSU?id=' + id + '&number=' + number;
        }
    }

    function quxiaokaishiHSU() {
        if(confirm("确定取消开始吗？")){
            location.href='../test/quxiaokaishiHSU';
        }
