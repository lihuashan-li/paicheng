    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <button type="submit" class="btn btn-default" data-toggle="modal" data-target="#myModal3D"><i
                        class="fa fa-cube"></i>试验完成查询
                </button>

                <button type="submit" class="btn btn-default" data-toggle="modal" data-target="#myModalQuXiao3D"><i
                        ...
                        <div id="shuju" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                ...
                                <td class="text-center">
                                    <div class="modal fadeA" id="myModal3D" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-sm " style=" width: 600px;height:500px;">
                                            <div class="modal-content">
                                                ...
                                                <a>请选择搜索时间范围</a>
                                                <form id="formASD" action="../test/findByendTime3D"
                                                      method="post">
                                    ...
                                    <%--取消查询模态框--%>
                                    <div class="modal fadeA" id="myModalQuXiao3D" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-sm " style=" width: 600px;height:500px;">
                                            <div class="modal-content">
                                                ...
                                                <a>请选择搜索时间范围</a>
                                                <form id="formQuXiao" action="../test/findByCancellationTime3D"
                                                      method="post">
                                                    <div class="row data-type">
    ...
    <script>
        ...
        function shujudaochu3D(){
            ...
            if(A==1){
                ...
                form.attr('action', '${pageContext.request.contextPath}/test/shujudaochu3DWanCheng');
