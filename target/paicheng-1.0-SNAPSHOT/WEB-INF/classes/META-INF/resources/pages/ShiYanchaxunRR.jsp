									...
									<div class="modal fadeA" id="myModalBBBBEEE" tabindex="-1" role="dialog"
										...
										<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;">
											<div class="modal-content">
                                                ...
                                                <a>请选择搜索时间范围</a>
												<form id="formASD" action="../test/findByendTimeRR"
													  method="post">
                                        ...
                                        <div class="modal fadeA" id="myModalQuXiao" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-sm " style=" width: 600px;height:500px;">
                                                <div class="modal-content">
                                                    ...
                                                    <a>请选择搜索时间范围</a>
                                                    <form id="formQuXiao" action="../test/findByCancellationTimeRR"
                                                          method="post">
                                                        <div class="row data-type">
	...
	//	处理详情请求的事件
        ...
        function shujudaochu(){
            ...
            if(A==1){
                ...
                form.attr('action', '${pageContext.request.contextPath}/test/shujudaochuRRWanCheng');
