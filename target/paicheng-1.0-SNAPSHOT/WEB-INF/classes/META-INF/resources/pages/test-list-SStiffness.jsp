        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <button type="button" class="btn btn-default" title="数据导出"
                        onclick="location.href='../test/ShuJuDaoChuSStiffness'">
                    ...
                    <div class="table-box">
                        ...
                        <div class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                ...
                                <tbody>
                                <%--<from  >--%>
                                <c:forEach items="${testListSStiffness.list}" var="test" varStatus="cou">
                                    ...
                                    <tr id="triesred${test.red}" onclick="ValuesAAA('${test.id}')">
                                        ...
                                        <td><input id="duoxuan${test.spbh}${test.red}" name="idsClass" type="checkbox"
                                                   ...
                                                   caozuo="${test.caozuo}" onclick="aaaaa(this)"></td>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP操作">--%>
                                                <button type="submit" class="btn bg-olive btn-xs" data-toggle="modal"
                                                        data-target="#myModalSStiffness"
                                                        onclick="ValuesSStiffness(${test.number},'${test.id}',${test.spbh},${test.red},${test.caozuo})">操作
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP取消">--%>
                                                <button id="buttonA" type="button" class="btn bg-olive btn-xs"
                                                    <%--onclick="location.href='../test/updateCancelSStiffness?id=${test.id}&number=${test.number}'">--%>
                                                        onclick="ValuesQuXiaoStiffness('${test.id}',${test.number})">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                        ...
                                        <td class="text-center" id="quxiaokaishi${test.spbh}">
                                                <%--<shiro:hasPermission name="SP完成">--%>
                                            <button id="button" type="button" class="btn bg-olive btn-xs"
                                                    onclick="quxiaokaishiStiffness()">取消开始
                                            </button>
                                                <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <div class="text-center">
                                    <div class="modal fadeA" id="myModalSStiffness" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelSStiffness" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                ...
                                                <form id="form" action="../test/TestNumberSStiffness" method="post">
                                                ...
                                                <form id="formAAA" action="../abnormal/saveAbnormalSStiffness" method="post">
                                                    <h4>请输入试验暂停原因：</h4>
                                    ...
                                    <div class="modal fadeA" id="myModalAbnormal" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelSSSStiffness" aria-hidden="true">
                                    ...
                                    <div class="modal fadeA" id="myModalSPPiLiang" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelSStiffnessPiLiang" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"
                                                ...
                                                <form id="formPiLiang" action="../test/PiLiangTestNumberSStiffness"
                                                      method="post">
                                                ...
                                                <form action="../test/JinRuDaiPaiSStiffness" method="post">
                                                ...
                                                <form action="../test/PiLiangQuXiaoYiPaiSStiffness" method="post">
            ...
            <div style="height: 65px" class="box-footer">
                <div style="float: right">
                    <ul STYLE="margin:5px" class="pagination">
                        <li><a>已排共计${countSStiffness}条数据</a></li>
                        <li>
                            <a href="../test/findTestByTestItemSStiffness?page=1&size=${testListSStiffness.pageSize}"
                               aria-label="Previous">首页</a>
                        </li>
                        <li><a href="../test/findTestByTestItemSStiffness?page=${testListSStiffness.pageNum-1}&size=${testListSStiffness.pageSize}">上一页</a>
                        </li>
                        <c:forEach begin="1" end="${testListSStiffness.pages}" var="pppp">
                            <li>
                                <a href="../test/findTestByTestItemSStiffness?page=${pppp}&size=${testListSStiffness.pageSize}">${pppp}</a>
                            </li>
                        </c:forEach>
                        <li><a href="../test/findTestByTestItemSStiffness?page=${testListSStiffness.pageNum+1}&size=${testListSStiffness.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="../test/findTestByTestItemSStiffness?page=${testListSStiffness.pages}&size=${testListSStiffness.pageSize}"
                    ...
                    <div class="table-box">
                                ...
                                <div>
                                    ...
                                    <%--<shiro:hasPermission name="SP待排批量操作">--%>
                                        <button type="submit" id="Dsubmit" class="btn btn-default" title="批量操作"
                                                ...
                                                data-target="#myModalSStiffnessPiLiangDaiPai" onclick="pilianganniuDaiPai()">
                                            <i class="fa fa-cube"></i>批量操作
                                        </button>
                                    <%--</shiro:hasPermission>--%>
                                    <button type="button" class="btn btn-default" title="待排数据导出"
                                            onclick="location.href='../test/ShuJuDaoChuDaiPaiSStiffness'">
                                        <i class="fa fa-cube"></i> 待排数据导出
                                    </button>

                                    待排共计${countDaiSStiffness}条


                                    <div style="width: 230px;height: 30px;float: right">
                                        <form action="../test/findByTestRequestIdDaiPaiSStiffness" method="post">
                        ...
                        <div id="daipai" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataListAAAA"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP顺位排程">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/updateStateSStiffness?id=${test.idRctest}'">
                                                    顺位排程
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                            ...
                                            <div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="formB" action="../test/TestNumberChaSStiffness" method="post">
                                                            <h4>请输入需要把该数据调整到第几位：</h4>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP待排取消">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/TestCancelSStiffness?id=${test.idRctest}'">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <%--批量操作模态框--%>
                                <div class="modal fadeA" id="myModalSStiffnessPiLiangDaiPai" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabelSStiffnessPiLiangD" aria-hidden="true">
                                    <div style=" width: 350px;height:350px;text-align: center"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="formPiLiangChaWei" action="../test/PiLiangChaWeiSStiffness" method="post">
                                            ...
                                            <form action="../test/PiLiangShunWeiSStiffness" method="post">
                                            ...
                                            <form action="../test/PiLiangQuXiaoSStiffness" method="post">
...
<script>
    ...
    //已排计划单个操作 数据进入到模态框
    $("#myModalSStiffness").modal("hide");

    function ValuesSStiffness (ID,id,spbh,red,caozuo) {
        $("#ids").val(ID);
        $("#id").val(id);
        $("#idss").val(ID);
        $("#idID").val(id);
    ...
    function kaishi(_this) {
        ...
        if ($($(_this).parent().parent().children()[1])[0].innerHTML == 1) {
            location.href = '../test/BeginSStiffness?number=' + number;
        } else {
    ...
    function wancheng(id, number) {
        location.href = '../test/updateCompleteSStiffness?id=' + id + '&number=' + number;
    }



    function ValuesQuXiaoStiffness (id,number) {
        if (confirm("操作确认!")){
            location.href='../test/updateCancelSStiffness?id=' + id + '&number=' + number;
        }


    }

    function quxiaokaishiStiffness() {
        if(confirm("确定取消开始吗？")){
            location.href='../test/quxiaokaishiStiffness';
        }
