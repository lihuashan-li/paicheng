    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <button type="submit" class="btn btn-default" data-toggle="modal" data-target="#myModalABC"><i
                        class="fa fa-cube"></i>筛选
                </button>

                <button type="button" class="btn btn-default" title="返回"
                        onclick="location.href='../pages/WeiTuoChaXun.jsp'">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <!--数据列表-->
                        <div id="chaxun" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                ...
                                <c:forEach items="${listAAA}" var="test" varStatus="cou">

                                    <tr id="triesred${test.red}" onclick="ValuesAAA('${test.idRctest}')">
                                        ...
                                        <td class="text-center">
                                            <!-- 操作模态框（Modal） -->
                                            <div class="modal fadeA" id="myModal" tabindex="-1" role="dialog"
                                                        ...
                                                        <form id="form" action="../test/TestNumber" method="post">
                                                            ...
                                                            <div class="modal-footer">
                                                                <input type="submit" class="btn btn-primary"
                                                                       value="提交更改" onclick="return tijiao()">
                                ...
                                <%--筛选--%>
                                <td class="text-center">
                                    <div class="modal fadeA" id="myModalABC" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelBA" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 620px;height:500px;">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <a>请选择</a>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                ...
                                                <form id="formWeiTuoWC" action="../test/findByWeiTuoB"
                                                      method="post">
                                                    <div>
                                                        <div style="text-align: left;padding-left:13px;font-size: 19px;font-weight: bold">
                                                            请选择实验室：
                                                            <label><input name="FruitA" type="radio" value="BC"
                                                                          checked/>BC </label>
                                                            <label><input name="FruitA" type="radio"
                                                                          value="RR,RPK,CDRR"/>RR </label>
                                                            <label><input name="FruitA" type="radio"
                                                                          value="HSU,LSU,Flatspot"/>HSU </label>
                                                            <label><input name="FruitA" type="radio"
                                                                          value="KZ: Vertical Stiffness,KX: Longitudinal Stiffness,KY: Lateral Stiffness,KT: Torsional Stiffness,KE: Enveloping Stiffness"/>Stiffness
                                                            </label>
                                                            <label><input name="FruitA" type="radio" value="Footprint"/>Footprint
                                                            </label>
                                                            <label><input name="FruitA" type="radio"
                                                                          value="Profile Scan(Unload),Profile Scan(Rim),Profile Scan(NonRim),Profile Scan(Loaded),Profile Scan(Wear)"/>3D
                                                            </label><br/><br/>
                                                            请选择状态：
                                                            <label><input name="zhuangtaiA" type="radio" value="2"
                                                                          onclick="aaaa(this)"/>未完成 </label>
                                                            <label><input name="zhuangtaiA" type="radio" value="1"
                                                                          onclick="bbbb(this)" checked/>完成 </label>
                                                            <label><input name="zhuangtaiA" type="radio" value="0"
                                                                          onclick="cccc(this)"/>取消</label><br/><br/>
                                                        </div>

                                                        <div class="row data-type" id="id01">
                                                            请输入搜索时间段<br/>
                                                            <div class="col-md-2 title">开始时间</div>
                                                            <div class="col-md-4 data">

                                                                <input id="startWT" name="startWT"
                                                                       onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss', el:'startWT', maxDate:'#F{$dp.$D(\'endWT\')}'})"
                                                            ...
                                                            <div class="col-md-4 data">
                                                                <input id="endWT" name="endWT"
                                                                       onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss', el:'endWT', minDate:'#F{$dp.$D(\'startWT\')}'})"
                                                                       type="text" readonly="readonly"
                                                                       class="form-control"
                                                                       style="cursor: pointer;">
                                                            </div>
                                        ...
                                        <div class="modal-dialog modal-sm ">
                                            <div class="modal-content" style=" width: 450px;height:150px;">
                                                <div class="modal-header">
                                                    ...
                                                    <h3 class="modal-title" id="myModalA" style="color: #00a7d0">
                                                        当前试验暂停的原因是：</h3>
            ...
            <div style="height: 65px" class="box-footer">
                ...
                <div style="float: right">
                    <ul STYLE="margin:5px" class="pagination">
                        <li>
                            <a href="../test/findByWeiTuoB?page=1&size=${testList.pageSize}"
                               aria-label="Previous">首页</a>
                        </li>
                        <li><a href="../test/findByWeiTuoB?page=${testList.pageNum-1}&size=${testList.pageSize}">上一页</a>
                        </li>
                        <c:forEach begin="1" end="${testList.pages}" var="pppp">
                            <li>
                                <a href="../test/findByWeiTuoB?page=${pppp}&size=${testList.pageSize}">${pppp}</a>
                            </li>
                        </c:forEach>
                        <li><a href="../test/findByWeiTuoB?page=${testList.pageNum+1}&size=${testList.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="../test/findByWeiTuoB?page=${testList.pages}&size=${testList.pageSize}"
        ...
        function aaaa(_this) {
            if ($(_this).get(0).checked) {
                ...
                function checkNumberBB() {
                    //  获取到用户输入信
                    var number = document.getElementById("startWT").value;
                    //正则表达式 不能为空
                    var reg_username = /\S/;
                    //判断
                    var flag = reg_username.test(number);
                ...
                function checkNumberABB() {
                    //  获取到用户输入信
                    var number = document.getElementById("endWT").value;
                    //正则表达式 不能为空
                    var reg_username = /\S/;
                    //判断
                    var flag = reg_username.test(number);
