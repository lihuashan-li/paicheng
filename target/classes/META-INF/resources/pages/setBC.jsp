		...
		<form method="post">
			...
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					<div class="panel-heading">BC实验室工时设定</div>
						...
						<tr>
							...
							<div>
								<button style="float: left" type="button" class="btn btn-default" title="刷新"
										onclick="location.href='../workTimeBC/findWorkTimeShuaXinBC'">
									<i class="fa fa-cube"></i> 刷新
								</button>
								<button style="float: left" type="button" class="btn bg-default"
										onclick="location.href='../test/findTestByTestItemBC'">返回
								</button>
								<a>今天向前2天的时间已经隐藏，如需查看，请搜索</a>

								<div style="width: 230px;height: 30px;float: right">
									<form action="../workTimeBC/findWorkTimeSouSuoBC" method="post">
					...
					<tr>
						...
						<td id="qqq" class="text-center">
							<button type="button" class="btn bg-olive btn-xs"
									onclick="location.href='../workTimeBC/deleteWorkTimeIdBC?id=${Work.id}'">删除</button>
						</td>
						<%--<td class="text-center">--%>
							<%--<button type="submit" class="btn bg-olive btn-xs"  data-toggle="modal" data-target="#myModalBC"  onclick="ValuesS('${Work.id}')">修改</button>--%>
							<%--<div class="modal fadeA" id="myModalBC" tabindex="-1" role="dialog" aria-labelledby="myModalLabelB" aria-hidden="true">--%>
								<%--<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;" >--%>
									<%--<div class="modal-content" >--%>
										...
										<%--</div>--%>
										<%--<form id="formB" action="../workTimeBC/UpdateWorkTimeBC" method="post">--%>
											<%--<div class="row data-type">--%>
		...
		<script>
            ...
            function baocun(){
                ...
                if(flag==false){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath }/workTimeBC/setBC",
                        type:"POST",
                        async:false,
                        traditional:true,
                        data:{
                        ...
                        success:function(data){
                            alert(data);
                            window.location.href='../workTimeBC/findWorkTimeShuaXinBC';
