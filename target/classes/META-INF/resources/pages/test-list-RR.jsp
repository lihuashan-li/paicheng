            ...
            <div class="box box-primary">
                ...
                <%--<shiro:hasPermission name="SP已排批量操作">--%>
                    <button type="submit" id="submit" class="btn btn-default" title="批量操作" class="btn bg-olive btn-xs"
                            data-toggle="modal" data-target="#myModalRRPiLiang" onclick="pilianganniu()">
                        <i class="fa fa-cube"></i> 批量操作
                    </button>
                <%--</shiro:hasPermission>--%>

                <button type="button" class="btn btn-default" title="数据导出"
                        onclick="location.href='../test/ShuJuDaoChuRR'">
                        ...
                        <div class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP取消">--%>
                                                <button id="buttonA" type="button" class="btn bg-olive btn-xs"
                                                        <%--onclick="location.href='../test/updateCancelRR?id=${test.id}&number=${test.number}'">--%>
                                                        onclick="ValuesQuXiao('${test.id}',${test.number})">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <div class="text-center">
                                    <div class="modal fadeA" id="myModalRR" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelRR" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                ...
                                                <form id="form" action="../test/TestNumberRR" method="post">
                                                    <h4>当前该实验是第<input name="ids" id="idss" type="button"
                                                                      readonly="readonly" value="">位</h4>
                                                    <h4>请输入需要把该数据调整到第几位：</h4>
                                                    <input type="text" class="text-center" name="number"
                                                           id="number"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input type="submit" class="btn btn-primary" value="提交更改"
                                                               onclick="return tijiaoDanGeRR()">

                                                    </div>

                                                </form>
                                                <form id="formAAA" action="../abnormal/saveAbnormalRR" method="post">
                                                    <h4>请输入试验暂停原因：</h4>
                                ...
                                <%--批量操作模态框--%>
                                <div class="modal fadeA" id="myModalRRPiLiang" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabelRRPiLiang" aria-hidden="true">
                                    <div class="modal-dialog modal-sm " style=" width: 500px;height:350px;top:25px">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-hidden="true">&times;
                                            ...
                                            <form id="formPiLiang" action="../test/PiLiangTestNumberRR"
                                                  method="post">
                                            ...
                                            <form action="../test/JinRuDaiPaiRR" method="post">
                                            ...
                                            <form action="../test/PiLiangQuXiaoYiPaiRR" method="post">
                                            ...
                                            <form action="../test/TiaoZhengShiJianRR" method="post">

                                                <h4>设置选中的实验的测试时间</h4>


                                                <div class="col-md-4 data">
                                                    <input id="TiaoZhengShiJianDataID" name="TiaoZhengShiJianData"
                                                ...
                                                <input name="id" id="TiaoZhengShiJianId" type="hidden" value="">
                                                <input name="number" id="TiaoZhengShiJianNumber" type="hidden" value="">

                                                <div class="modal-footer">

                                                    <input type="submit" class="btn btn-primary" value="提交更改"
                                                           onclick="return TiaoZhengShiJian()">
            ...
            <div style="height: 65px" class="box-footer">
                <div style="float: right">
                    <ul STYLE="margin:5px" class="pagination">
                        ...
                        <li>
                            <a href="../test/findTestByTestItemRR?page=1&size=${testList.pageSize}"
                               aria-label="Previous">首页</a>
                        </li>
                        <li><a href="../test/findTestByTestItemRR?page=${testList.pageNum-1}&size=${testList.pageSize}">上一页</a>
                        </li>
                        <%--<c:forEach begin="1" end="${testList.pages}" var="pppp">--%>
                        <%--<li>--%>
                        <%--<a href="../test/findTestByTestItemRR?page=${pppp}&size=${testList.pageSize}">${pppp}</a>--%>
                        <%--</li>--%>

                        <%--</c:forEach>--%>

                        <c:if test="${testList.pageNum<=pageCount}">
                            <%--在页面展示出6条页码数--%>
                            <c:forEach begin="${testList.pageNum}"
                                       end="${testList.pageNum<=pageCount-5?testList.pageNum+5:pageCount}"
                                       var="pageNum">
                                <li <c:if test="${testList.pageNum == pageNum}">class="active" </c:if>><%--显示选中的页数--%>
                                    <a href="../test/findTestByTestItemRR?page=${pageNum}&size=${testList.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                        </c:if>

                        <li><a href="../test/findTestByTestItemRR?page=${testList.pageNum+1}&size=${testList.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="../test/findTestByTestItemRR?page=${testList.pages}&size=${testList.pageSize}"
                    ...
                    <div class="table-box">
                                ...
                                <div>
                                    ...
                                    <%--<shiro:hasPermission name="SP待排批量操作">--%>
                                        <button type="submit" id="Dsubmit" class="btn btn-default" title="批量操作"
                                                ...
                                                data-target="#myModalRRPiLiangDaiPai" onclick="pilianganniuDaiPai()">
                                            <i class="fa fa-cube"></i>批量操作
                                        </button>
                                    <%--</shiro:hasPermission>--%>

                                    <button type="button" class="btn btn-default" title="待排数据导出"
                                            onclick="location.href='../test/ShuJuDaoChuDaiPaiRR'">
                                    ...
                                    <div style="width: 230px;height: 30px;float: right">
                                        <form action="../test/findByTestRequestIdDaiPaiRR" method="post">
                        ...
                        <div id="daipai" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataListAAAA"
                                ...
                                <c:forEach items="${RR}" var="test" varStatus="cou">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP顺位排程">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/updateStateRR?id=${test.idRctest}'">
                                                    顺位排程
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                            ...
                                            <div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="formB" action="../test/TestNumberRRR" method="post">
                                                            <h4>请输入需要把该数据调整到第几位：</h4>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP待排取消">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/TestCancelRR?id=${test.idRctest}'">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <%--批量操作模态框--%>
                                <div class="modal fadeA" id="myModalRRPiLiangDaiPai" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabelRRPiLiangD" aria-hidden="true">
                                    <div style=" width: 350px;height:350px;text-align: center"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="formPiLiangChaWei" action="../test/PiLiangChaWeiRR" method="post">
                                            ...
                                            <form action="../test/PiLiangShunWeiRR" method="post">
                                            ...
                                            <form action="../test/PiLiangQuXiaoRR" method="post">
...
<script>
    ...
    function tijiaoDanGeRR() {
        return checkNumberADan() &&  checkNumberDan()  && checkNumberACDan() && checkNumberABCCDan() && checkNumberABDan()  && checkNumberABCABCCDan();
    }
    ...
    function kaishi(_this) {
            ...
            if ($($(_this).parent().parent().children()[1])[0].innerHTML == 1) {
                location.href = '../test/BeginRR?number=' + number;
            } else {

                if ($($(_this).parent().parent().prev().children()[21])[0].id == "wancheng0") {
                    alert("请先开始前一条试验")
                } else {
                    location.href = '../test/BeginRR?number=' + number;
                }
    ...
    function wancheng(id, number) {
        location.href = '../test/updateCompleteRR?id=' + id + '&number=' + number;
    }

    function ValuesQuXiao (id,number) {
        if (confirm("操作确认!")){
            location.href='../test/updateCancelRR?id=' + id + '&number=' + number;
        }


    }

    function quxiaokaishi() {
        if(confirm("确定取消开始吗？")){
            location.href='../test/quxiaokaishiRR';
         }
    ...
    function pilianganniu() {
        ...
        $("#TiaoZhengShiJianId").val(id);
        $("#TiaoZhengShiJianNumber").val(number);
    ...
    //已排 批量 设置排测时间
    function checkTiaoZhengShiJianA() {
        //  获取到用户选择
        var number = document.getElementById("TiaoZhengShiJianNumber").value;
        //正则表达式 不能为空
        var reg_username = /\S/;
        //判断
        var flag = reg_username.test(number);
    ...
    function checkTiaoZhengShiJianB() {
        //  获取到用户输入信
        var number = document.getElementById("TiaoZhengShiJianDataID").value;
        //正则表达式 不能为空
        var reg_username = /\S/;
        //判断
        var flag = reg_username.test(number);
    ...
    function TiaoZhengShiJian() {
        return checkTiaoZhengShiJianA() && checkTiaoZhengShiJianB();
    }
