            ...
            <div class="box box-primary">
                ...
                <%--<shiro:hasPermission name="SP已排批量操作">--%>
                    <button type="submit" id="submit" class="btn btn-default" title="批量操作" class="btn bg-olive btn-xs"
                            data-toggle="modal" data-target="#myModalBCPiLiang" onclick="pilianganniu()">
                        <i class="fa fa-cube"></i> 批量操作
                    </button>
                <%--</shiro:hasPermission>--%>

                <button type="button" class="btn btn-default" title="数据导出"
                        onclick="location.href='../test/ShuJuDaoChuBC'">
                    ...
                    <div class="table-box">
                        ...
                        <div class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                ...
                                <tbody>
                                <%--<from  >--%>
                                <c:forEach items="${testListBC.list}" var="test" varStatus="cou">
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP操作">--%>
                                                <button type="submit" class="btn bg-olive btn-xs" data-toggle="modal"
                                                        data-target="#myModalBC"
                                                        onclick="ValuesBC(${test.number},'${test.id}',${test.spbh},${test.red},${test.caozuo})">操作
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP取消">--%>
                                                <button id="buttonA" type="button" class="btn bg-olive btn-xs"
                                                    <%--onclick="location.href='../test/updateCancelSStiffness?id=${test.id}&number=${test.number}'">--%>
                                                        onclick="ValuesQuXiaoBC('${test.id}',${test.number})">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <div class="text-center">
                                    <div class="modal fadeA" id="myModalBC" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelBC" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                ...
                                                <form id="form" action="../test/TestNumberBC" method="post">
                                                ...
                                                <form id="formAAA" action="../abnormal/saveAbnormalBC" method="post">
                                                    <h4>请输入试验暂停原因：</h4>
                                    ...
                                    <%--批量操作模态框--%>
                                    <div class="modal fadeA" id="myModalBCPiLiang" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabelBCPiLiang" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"
                                                ...
                                                <form id="formPiLiang" action="../test/PiLiangTestNumberBC"
                                                      method="post">
                                                ...
                                                <form action="../test/JinRuDaiPaiBC" method="post">
                                                ...
                                                <form action="../test/PiLiangQuXiaoYiPaiBC" method="post">
            ...
            <div style="height: 65px" class="box-footer">
                <div style="float: right">
                    <ul STYLE="margin:5px" class="pagination">
                        ...
                        <li>
                            <a href="../test/findTestByTestItemBC?page=1&size=${testListBC.pageSize}"
                               aria-label="Previous">首页</a>
                        </li>
                        <li><a href="../test/findTestByTestItemBC?page=${testListBC.pageNum-1}&size=${testListBC.pageSize}">上一页</a>
                        </li>
                        <c:forEach begin="1" end="${testListBC.pages}" var="pppp">
                            <li>
                                <a href="../test/findTestByTestItemBC?page=${pppp}&size=${testListBC.pageSize}">${pppp}</a>
                            </li>
                        </c:forEach>
                        <li><a href="../test/findTestByTestItemBC?page=${testListBC.pageNum+1}&size=${testListBC.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="../test/findTestByTestItemBC?page=${testListBC.pages}&size=${testListBC.pageSize}"
                    ...
                    <div class="table-box">
                                ...
                                <div>
                                    ...
                                    <%--<shiro:hasPermission name="SP待排批量操作">--%>
                                        <button type="submit" id="Dsubmit" class="btn btn-default" title="批量操作"
                                                ...
                                                data-target="#myModalBCPiLiangDaiPai" onclick="pilianganniuDaiPai()">
                                            <i class="fa fa-cube"></i>批量操作
                                        </button>
                                    <%--</shiro:hasPermission>--%>
                                    <button type="button" class="btn btn-default" title="待排数据导出"
                                            onclick="location.href='../test/ShuJuDaoChuDaiPaiBC'">
                                    ...
                                    <div style="width: 230px;height: 30px;float: right">
                                        <form action="../test/findByTestRequestIdDaiPaiBC" method="post">
                        ...
                        <div id="daipai" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataListAAAA"
                                ...
                                <c:forEach items="${BC}" var="test" varStatus="cou">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP顺位排程">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/updateStateBC?id=${test.idRctest}'">
                                                    顺位排程
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                            ...
                                            <div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="formB" action="../test/TestNumberChaBC" method="post">
                                                            <h4>请输入需要把该数据调整到第几位：</h4>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP待排取消">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/TestCancelBC?id=${test.idRctest}'">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <%--批量操作模态框--%>
                                <div class="modal fadeA" id="myModalBCPiLiangDaiPai" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabelBCPiLiangD" aria-hidden="true">
                                    <div style=" width: 350px;height:350px;text-align: center"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="formPiLiangChaWei" action="../test/PiLiangChaWeiBC" method="post">
                                            ...
                                            <form action="../test/PiLiangShunWeiBC" method="post">
                                            ...
                                            <form action="../test/PiLiangQuXiaoBC" method="post">
...
<script>
    ...
    //已排计划单个操作 数据进入到模态框
    $("#myModalBC").modal("hide");

    function ValuesBC (ID,id,spbh,red,caozuo) {
        $("#ids").val(ID);
        $("#id").val(id);
        $("#idss").val(ID);
        $("#idID").val(id);
    ...
    function kaishi(_this) {
        ...
        if ($($(_this).parent().parent().children()[1])[0].innerHTML == 1) {
            location.href = '../test/BeginBC?number=' + number;
        } else {
            if ($($(_this).parent().parent().prev().children()[18])[0].id == "wancheng0") {
                alert("请先开始前一条试验")
            } else {
                location.href = '../test/BeginBC?number=' + number;
            }
    ...
    function wancheng(id, number) {
        location.href = '../test/updateCompleteBC?id=' + id + '&number=' + number;
    }



    function ValuesQuXiaoBC (id,number) {
        if (confirm("操作确认!")){
            location.href='../test/ValuesQuXiaoBC?id=' + id + '&number=' + number;
        }
    }

    function quxiaokaishiBC() {
        if(confirm("确定取消开始吗？")){
            location.href='../test/quxiaokaishiBC';
        }
