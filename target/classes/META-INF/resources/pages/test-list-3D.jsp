            ...
            <div class="box box-primary">
                ...
                <%--<shiro:hasPermission name="SP已排批量操作">--%>
                    <button type="submit" id="submit" class="btn btn-default" title="批量操作" class="btn bg-olive btn-xs"
                            data-toggle="modal" data-target="#myModal3DPiLiang" onclick="pilianganniu()">
                        <i class="fa fa-cube"></i> 批量操作
                    </button>
                <%--</shiro:hasPermission>--%>

                <button type="button" class="btn btn-default" title="数据导出"
                        onclick="location.href='../test/ShuJuDaoChu3D'">
                    ...
                    <div class="table-box">
                        ...
                        <div class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataList"
                                ...
                                <tbody>
                                <%--<from  >--%>
                                <c:forEach items="${testList3D.list}" var="test" varStatus="cou">
                                            ...
                                            <%--<shiro:hasPermission name="SP取消">--%>
                                                <button id="buttonA" type="button" class="btn bg-olive btn-xs"
                                                    <%--onclick="location.href='../test/updateCancelSStiffness?id=${test.id}&number=${test.number}'">--%>
                                                        onclick="ValuesQuXiao3D('${test.id}',${test.number})">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <div class="text-center">
                                    <div class="modal fadeA" id="myModal3D" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                ...
                                                <form id="form" action="../test/TestNumber3D" method="post">
                                                ...
                                                <form id="formAAA" action="../abnormal/saveAbnormal3D" method="post">
                                                    <h4>请输入试验暂停原因：</h4>
                                    ...
                                    <%--批量操作模态框--%>
                                    <div class="modal fadeA" id="myModal3DPiLiang" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabel3DPiLiang" aria-hidden="true">
                                        <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal"
                                                ...
                                                <form id="formPiLiang" action="../test/PiLiangTestNumber3D"
                                                      method="post">
                                                ...
                                                <form action="../test/JinRuDaiPai3D" method="post">
                                                ...
                                                <form action="../test/PiLiangQuXiaoYiPai3D" method="post">
            ...
            <div style="height: 65px" class="box-footer">
                <div style="float: right">
                    <ul STYLE="margin:5px" class="pagination">
                        ...
                        <li>
                            <a href="../test/findTestByTestItem3D?page=1&size=${testList3D.pageSize}"
                               aria-label="Previous">首页</a>
                        </li>
                        <li><a href="../test/findTestByTestItem3D?page=${testList3D.pageNum-1}&size=${testList3D.pageSize}">上一页</a>
                        </li>
                        <c:forEach begin="1" end="${testList3D.pages}" var="pppp">
                            <li>
                                <a href="../test/findTestByTestItem3D?page=${pppp}&size=${testList3D.pageSize}">${pppp}</a>
                            </li>
                        </c:forEach>
                        <li><a href="../test/findTestByTestItem3D?page=${testList3D.pageNum+1}&size=${testList3D.pageSize}">下一页</a>
                        </li>
                        <li>
                            <a href="../test/findTestByTestItem3D?page=${testList3D.pages}&size=${testList3D.pageSize}"
                    ...
                    <div class="table-box">
                                ...
                                <div>
                                    ...
                                    <%--<shiro:hasPermission name="SP待排批量操作">--%>
                                        <button type="submit" id="Dsubmit" class="btn btn-default" title="批量操作"
                                                ...
                                                data-target="#myModal3DPiLiangDaiPai" onclick="pilianganniuDaiPai()">
                                            <i class="fa fa-cube"></i>批量操作
                                        </button>
                                    <%--</shiro:hasPermission>--%>
                                    ...
                                    <div style="width: 230px;height: 30px;float: right">
                                        <form action="../test/findByTestRequestIdDaiPai3D" method="post">
                        ...
                        <div id="daipai" class="ccc table table-bordered table-striped table-hover dataTable">
                            <table id="dataListAAAA"
                                ...
                                <c:forEach items="${D}" var="test" varStatus="cou">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP顺位排程">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/updateState3D?id=${test.idRctest}'">
                                                    顺位排程
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                            ...
                                            <div class="modal fadeA" id="myModalB" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog modal-sm " style=" width: 350px;height:350px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="formB" action="../test/TestNumberCha3D" method="post">
                                                            <h4>请输入需要把该数据调整到第几位：</h4>
                                        ...
                                        <td class="text-center">
                                            <%--<shiro:hasPermission name="SP待排取消">--%>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick="location.href='../test/TestCancel3D?id=${test.idRctest}'">
                                                    案件取消
                                                </button>
                                            <%--</shiro:hasPermission>--%>
                                        </td>
                                ...
                                <%--批量操作模态框--%>
                                <div class="modal fadeA" id="myModal3DPiLiangDaiPai" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabel3DPiLiangD" aria-hidden="true">
                                    <div style=" width: 350px;height:350px;text-align: center"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="formPiLiangChaWei" action="../test/PiLiangChaWei3D" method="post">
                                            ...
                                            <form action="../test/PiLiangShunWei3D" method="post">
                                            ...
                                            <form action="../test/PiLiangQuXiao3D" method="post">
...
<script>
    ...
    function kaishi(_this) {
        ...
        if ($($(_this).parent().parent().children()[1])[0].innerHTML == 1) {
            location.href = '../test/Begin3D?number=' + number;
        } else {
    ...
    function wancheng(id, number) {
        location.href = '../test/updateComplete3D?id=' + id + '&number=' + number;
    }



    function ValuesQuXiao3D (id,number) {
        if (confirm("操作确认!")){
            location.href='../test/ValuesQuXiao3D?id=' + id + '&number=' + number;
        }
    }

    function quxiaokaishi3D() {
        if(confirm("确定取消开始吗？")){
            location.href='../test/quxiaokaishi3D';
        }
