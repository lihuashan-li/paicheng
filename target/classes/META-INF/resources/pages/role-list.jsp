					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="location.href='../role/findAll'">
							...
							<div style="width: 230px;height: 30px;float: right">
								<form action="../role/findByRoleRoleNzme" method="post">

									<input style="width: 175px;height: 30px; border-radius:3px" type="text"  name="roleName"
										   placeholder="请输入角色名称查询" value="">
									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="../role/DeleteById?id=${role.id}" class="btn bg-olive btn-xs">删除</a>
												<a href="../role/findRoleByIdAndAllPermission?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
