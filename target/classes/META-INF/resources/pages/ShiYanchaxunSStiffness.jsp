...
<div id="divall">
	...
	<div class="wrapper" >
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					SStiffness实验室试验执行履历 <small>数据列表</small>
				</h1>
				<ol class="breadcrumb">
			...
			<section class="content">
				...
				<div class="box box-primary">
					...
					<button type="submit" class="btn btn-default" data-toggle="modal" data-target="#myModalSS"><i
					class="fa fa-cube"></i>试验完成查询
					</button>

                    <button type="submit" class="btn btn-default" data-toggle="modal" data-target="#myModalQuXiaoSS"><i
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<td class="text-center">
									<div class="modal fadeA" id="myModalSS" tabindex="-1" role="dialog"
										...
										<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;">
											<div class="modal-content">
                                                ...
                                                <a>请选择搜索时间范围</a>
												<form id="formASD" action="../test/findByendTimeSStiffness"
													  method="post">
                                        ...
                                        <%--取消查询模态框--%>
                                        <div class="modal fadeA" id="myModalQuXiaoSS" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-sm " style=" width: 600px;height:500px;">
                                                <div class="modal-content">
                                                    ...
                                                    <a>请选择搜索时间范围</a>
                                                    <form id="formQuXiao" action="../test/findByCancellationTimeSStiffness"
                                                          method="post">
                                                        <div class="row data-type">
	...
	//	处理详情请求的事件
        ...
        function shujudaochuSStiffness(){
            var A='${A}'
            if(A==1){
                ...
                form.attr('action', '${pageContext.request.contextPath}/test/shujudaochuSStiffnessWanCheng');
