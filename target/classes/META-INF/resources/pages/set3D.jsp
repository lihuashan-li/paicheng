		...
		<form method="post">
			...
			<section class="content"> <!--产品信息-->
				...
				<div class="panel panel-default">
					<div class="panel-heading">3D实验室工时设定</div>
				...
				<div class="box-tools text-center">
					<button class="btn bg-maroon"  onclick="baocun()">
					保存</button>
						...
						<tr>
							...
							<div>
								<button style="float: left" type="button" class="btn btn-default" title="刷新"
										onclick="location.href='../workTime3D/findWorkTimeShuaXin3D'">
									<i class="fa fa-cube"></i> 刷新
								</button>
								<button style="float: left" type="button" class="btn bg-default"
										onclick="location.href='../test/findTestByTestItem3D'">返回
								</button>
								<a>今天向前2天的时间已经隐藏，如需查看，请搜索</a>
							       <div style="width: 230px;height: 30px;float: right">
									<form action="../workTime3D/findWorkTimeSouSuo3D" method="post">
					...
					<tr>
						...
						<td id="qqq" class="text-center">
							<button type="button" class="btn bg-olive btn-xs"
									onclick="location.href='../workTime3D/deleteWorkTimeId3D?id=${Work.id}'">删除</button>
						</td>
							...
							<%--<div class="modal fadeA" id="myModalBC" tabindex="-1" role="dialog" aria-labelledby="myModalLabelB" aria-hidden="true">--%>
								<%--<div class="modal-dialog modal-sm " style=" width: 600px;height:500px;" >--%>
									<%--<div class="modal-content" >--%>
										...
										<%--</div>--%>
										<%--<form id="formB" action="../workTime3D/UpdateWorkTime3D" method="post">--%>
											<%--<div class="row data-type">--%>
		...
		<script>
            ...
            function baocun(){
                ...
                if(flag==false){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath }/workTime3D/set3D",
                        type:"POST",
                        async:false,
                        traditional:true,
                        data:{
                        ...
                        success:function(data){
                            alert(data);
                            window.location.href='../workTime3D/findWorkTimeShuaXin3D'
